...
const About: React.FC = () => {
  return (
    <div className="about">
      <h1 className="about__title"><span>Unleash the Night:Unleash the Night: Navigate the Pulse of the Bar Scene</span></h1>
      <p className="about__description"><span>At our core, we're on a mission to unravel the pulse of the night, 
        ...
        Together, let's unlock the secrets of the city's bars and embark on a nightlife adventure like no other.</span></p>
    </div>
  );
};
